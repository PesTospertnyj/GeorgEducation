 ...
 */
public class GlobalGroupIdClass implements Serializable {

    private String univCode;
    private String groupCode;

    public GlobalGroupIdClass() {
    }

    public GlobalGroupIdClass(String univCode, String groupCode) {
    ...
    public boolean equals(Object o) {
        ...
        GlobalGroupIdClass that = (GlobalGroupIdClass) o;
